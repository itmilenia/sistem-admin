...
class CustomerTransactionController extends Controller
{
    ...
    {
        return view('pages.feat.customer.customer-transaction.index');
    }
    ...
    public function getData(Request $request)
    {
        ...
        $formattedData = $purchases->getCollection()->map(function ($item) {
            return [
                ...
                'action' => '<a href="' . route('customer-transaction.show', $item->SOIVH_InvoiceID) . '" class="btn btn-sm btn-info"><i class="feather-eye me-1"></i> Lihat</a>'
            ];
        });
    ...
    public function show($id)
    {
        ...
        return view('pages.feat.customer.customer-transaction.show', compact('invoiceHeader', 'invoiceDetails'));
    }
}
