...
class StoreQuotationLetterRequest extends FormRequest
{
    ...
    /**
     * Validation rules for storing a quotation letter.
     *
     */
    public function rules(): array
    {
        return [
            ...
            'quotation_letter_file' => ['required', 'file', 'mimes:pdf', 'max:10240'],
 ...
 */
    public function messages(): array
    {
        return [
            ...
            'quotation_letter_file.required' => 'File Surat (PDF) wajib diunggah.',
