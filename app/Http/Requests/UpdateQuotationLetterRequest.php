...
class UpdateQuotationLetterRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'quotation_letter_number.unique'   => 'Nomor Surat ini sudah digunakan oleh surat lain.', // Pesan spesifik update
            ...
            'signature_id.exists'   => 'Penanda tangan yang dipilih tidak ditemukan.',
            ...
            'items.required' => 'Daftar barang (items) wajib ada saat update.',
