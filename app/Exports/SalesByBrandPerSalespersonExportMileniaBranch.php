...
class SalesByBrandPerSalespersonExportMileniaBranch implements FromView, ShouldAutoSize
{
    protected $startDate;
    protected $endDate;
    ...
    public function view(): View
    {
        ...
        $salesData = DB::connection('sqlsrv_wh')
            ->table('SOIVD_CABANG')
            ...
            ->join('MFSSM', 'SOIVD_CABANG.SOIVD_SalesmanID', '=', 'MFSSM.MFSSM_SalesmanID') // Join ke tabel sales
            ->where('MFSSM.MFSSM_Active', 1) // Hanya sales yang aktif
            ->whereBetween('SOIVH_CABANG.SOIVH_InvoiceDate', [$queryStartDate, $queryEndDate])
            ->select(
