                    ...
                    <div class="row flex-1 g-0">
                        <div class="col-lg-6 h-100 my-auto">
                            ...
                            <div class="creative-card-body card-body p-sm-5">
                                <h2 class="fw-bolder mb-4" style="font-size: 120px">4<span class="text-danger">0</span>3
                                </h2>
                                <h4 class="fw-bold mb-2">Akses Ditolak</h4>
                                <p class="fs-12 fw-medium text-muted">
                                    Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.
                                    Silakan periksa kembali hak akses Anda atau hubungi administrator jika menurut Anda
                        ...
                        <div class="col-lg-6" style="background-color: #9898CA;">
                            <div class="h-100 d-flex align-items-center justify-content-center">
                                <img src="{{ asset('assets/images/errors/403.jpg') }}" alt="404 Not Found"
