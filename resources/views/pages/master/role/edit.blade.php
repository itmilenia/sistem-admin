...
@section('content')
    ...
    <div class="main-content">
        <form action="{{ route('master-role.update', $role->id) }}" method="POST" id="editRoleForm">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><i class="feather-edit me-2"></i>Edit Peran:
                                {{ ucwords(str_replace('_', ' ', $role->name)) }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <h6>Informasi Peran</h6>
                                    <p class="text-muted small">Ubah nama role. Pastikan tetap unik dan sesuai format.</p>
                                    <hr>
                                    <div class="mb-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <p class="text-muted small">Pilih hak akses yang akan dimiliki oleh role ini.</p>
                                    <hr>
                                    <div class="row">
