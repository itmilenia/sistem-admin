...
@section('content')
    <div class="page-header">
        ...
        <div class="page-header-right ms-auto">
            ...
            {{-- Tombol Cetak PDF (Opsional, jika nanti dibuatkan route print) --}}
            {{-- <a href="#" class="btn btn-primary"><i class="feather-printer me-2"></i> Cetak PDF</a> --}}
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($quotationLetter->details as $index => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold">{{ $item->itemMilenia->MFIMA_Description }}</td>
