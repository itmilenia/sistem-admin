                ...
                <div class="card stretch stretch-full">
                    ...
                    <div class="card-body">
                        <form id="edit-quotation-form" action="{{ route('quotation-letter.update', $quotationLetter->id) }}"
                            ...
                            {{-- ================= SECTION 3: ITEMS ================= --}}
                            <fieldset class="mb-4 p-3 border rounded-3">
                                <legend class="float-none w-auto px-2 fs-6 fw-bold">Detail Barang</legend>
                                        ...
                                        <tbody id="items-container">
                                            @foreach ($quotationLetter->details as $index => $detail)
                                                ...
                                                @php
                                                    ...
                                                    $itemName =
                                                        $detail->itemMilenia->MFIMA_Description ??
                                                        'Item Tidak Ditemukan';

                                                    // 2. Ambil Kategori Harga (fallback jika null)
                                                    $priceCategory = $detail->pricelistMilenia->SOMPD_PriceID ?? '-';
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                <a href="{{ route('quotation-letter.milenia.index') }}" class="btn btn-light">Batal</a>
    ...
    <script>
        ...
        function initSelect2(element) {
            $(element).select2({
                ...
                ajax: {
                    url: '{{ route('api.milenia-items.search') }}',
                    dataType: 'json',
                    delay: 250,
                    data: params => ({
                        q: params.term
        ...
        function confirmSubmit() {
            ...
            Swal.fire({
                title: 'Perbarui Data?',
                text: "Data surat akan diperbarui.",
                icon: 'question',
