...
@section('title', 'Data Surat Penawaran MAP')
            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><i class="feather-file-text me-2"></i>Daftar Semua Surat Penawaran MAP
                        </h5>
                        <a href="{{ route('quotation-letter.map.create') }}" class="btn btn-primary btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="hstack gap-2 justify-content-center">
                                                    ...
                                                    {{-- Tombol Edit --}}
                                                    <a href="{{ route('quotation-letter.map.edit', $quotationLetter->id) }}"
