...
@section('title', 'Detail Pending SO MAP Pusat')
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('pending-so.map.index') }}">Pending Sales Order MAP
                        Pusat</a></li>
        ...
        <div class="page-header-right ms-auto">
            <a href="{{ route('pending-so.map.index') }}" class="btn btn-secondary">
