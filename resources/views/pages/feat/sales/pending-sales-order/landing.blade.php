...
@section('title', 'Pilih Pending Sales Order')
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body py-5">
                <div class="text-center mb-5">
                    <h1 class="fw-bold mb-3">Pilih Pending Sales Order</h1>
                    <p class="lead text-muted">Silakan pilih Pending Sales Order perusahaan yang ingin ditampilkan</p>
                </div>

                <div class="row justify-content-center">
                    @can('lihat_pending_sales_order_milenia_pusat')
                        {{-- ========== MILENIA PUSAT ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                            <a href="{{ route('pending-so.milenia.index') }}" class="text-decoration-none">
                    ...
                    @can('lihat_pending_sales_order_milenia_cabang')
                        {{-- ========== MILENIA CABANG ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                            <a href="{{ route('pending-so.milenia-branch.index') }}" class="text-decoration-none">
                                <div class="card shadow-lg border-0 h-100 hover-card"
                    ...
                    @can('lihat_pending_sales_order_map_pusat')
                        {{-- ========== MAP PUSAT ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                            <a href="{{ route('pending-so.map.index') }}" class="text-decoration-none">
                                <div class="card shadow-lg border-0 h-100 hover-card"
                    ...
                    {{-- @can('lihat_pending_sales_order_map_cabang') --}}
                    {{-- ========== MAP CABANG ========== --}}
                    {{-- <div class="col-md-6 col-lg-6 mb-4">
