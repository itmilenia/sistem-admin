...
@section('title', 'Pending Sales Order Milenia Pusat')
            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header">
                        <h5 class="card-title">Daftar Pending Sales Order Milenia Pusat</h5>
                    </div>
                    <div class="card-body">
...
@push('scripts')
    ...
    <script>
        const baseDetailRoute = "{{ url('sales/pending-sales-order/milenia') }}/";
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData(cursor = null) {
                ...
                fetch(`{{ route('pending-so.milenia.data') }}?${params}`)
                    .then(res => res.json())
                    .then(res => {
