...
@section('title', 'Pending Sales Order MAP Pusat')
            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header">
                        <h5 class="card-title">Daftar Pending Sales Order MAP Pusat</h5>
                    </div>
                    <div class="card-body">
...
@push('scripts')
    ...
    <script>
        const baseDetailRoute = "{{ url('sales/pending-sales-order/map') }}/";
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData(cursor = null) {
                ...
                fetch(`{{ route('pending-so.map.data') }}?${params}`)
                    .then(res => res.json())
                    .then(res => {
