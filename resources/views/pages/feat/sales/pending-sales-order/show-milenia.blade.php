...
@section('title', 'Detail Pending SO Milenia Pusat')
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('pending-so.milenia.index') }}">Pending Sales Order Milenia
                        Pusat</a></li>
        ...
        <div class="page-header-right ms-auto">
            <a href="{{ route('pending-so.milenia.index') }}" class="btn btn-secondary">
