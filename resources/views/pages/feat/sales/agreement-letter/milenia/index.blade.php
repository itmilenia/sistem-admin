...
@section('title', 'Data Surat Agreement Milenia')
            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><i class="feather-file-text me-2"></i>Daftar Semua Surat Agreement Milenia
                        </h5>
                        {{-- Sesuaikan dengan route create Anda --}}
                        <a href="{{ route('agreement-letter.milenia.create') }}" class="btn btn-primary btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="hstack gap-2 justify-content-center">
                                                    {{-- Tombol Lihat --}}
                                                    <a href="{{ route('agreement-letter.milenia.show', $agreementLetter->id) }}"
                                                        class="btn btn-sm btn-info">
                                                        <i class="feather-eye me-2"></i> Lihat
                                                    </a>

                                                    {{-- Tombol Edit --}}
                                                    <a href="{{ route('agreement-letter.milenia.edit', $agreementLetter->id) }}"
