        ...
        <div class="card shadow-sm border-0">
            <div class="card-body py-5">
                <div class="text-center mb-5">
                    ...
                    <p class="lead text-muted">Silakan pilih jenis surat agreement dari perusahaan yang ingin ditampilkan</p>
                </div>

                <div class="row justify-content-center">
                    @can('lihat_surat_agreement_milenia')
                        {{-- ========== MILENIA PUSAT ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                            <a href="{{ route('agreement-letter.milenia.index') }}" class="text-decoration-none">
                    ...
                    @can('lihat_surat_agreement_map')
                        {{-- ========== MAP PUSAT ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                            <a href="{{ route('agreement-letter.map.index') }}" class="text-decoration-none">
                                <div class="card shadow-lg border-0 h-100 hover-card"
