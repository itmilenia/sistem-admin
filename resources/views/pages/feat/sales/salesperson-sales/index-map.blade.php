            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title">Daftar Penjualan per Sales (Mega Auto Prima - Pusat)</h5>
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('salesperson-sales.transactions.map.export-all-per-sales') }}" method="GET">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData(cursor = null) {
                ...
                fetch(`{{ route('salesperson-sales.transactions.map.data') }}?${params}`)
                    .then(res => res.json())
                    .then(res => {
