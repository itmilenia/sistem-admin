    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('salesperson-sales.transactions.milenia.index') }}">Data
                        Penjualan Sales</a></li>
                <li class="breadcrumb-item">Detail</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <a href="{{ route('salesperson-sales.transactions.milenia.index') }}" class="btn btn-secondary">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateExportLink() {
                ...
                if (startDate && endDate) {
                    ...
                    const baseUrl =
                        `{{ route('salesperson-sales.transactions.milenia.export-sales-by-brand', $salesperson->MFSSM_SalesmanID) }}`;
            ...
            function loadData(cursor = null) {
                ...
                const url =
                    `{{ route('salesperson-sales.transactions.milenia.data.details', $salesperson->MFSSM_SalesmanID) }}?${params}`;
