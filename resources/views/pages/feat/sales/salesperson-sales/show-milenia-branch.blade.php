    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('salesperson-sales.transactions.milenia.branch.index') }}">Data
                        Penjualan Sales</a></li>
                <li class="breadcrumb-item">Detail</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <a href="{{ route('salesperson-sales.transactions.milenia.branch.index') }}" class="btn btn-secondary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData(cursor = null) {
                ...
                const url =
                    `{{ route('salesperson-sales.transactions.milenia.data.branch.details', $salesperson->MFSSM_SalesmanID) }}?${params}`;
