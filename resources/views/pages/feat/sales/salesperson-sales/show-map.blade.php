    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('salesperson-sales.transactions.map.index') }}">Data
                        Penjualan Sales</a></li>
                <li class="breadcrumb-item">Detail</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <a href="{{ route('salesperson-sales.transactions.map.index') }}" class="btn btn-secondary">
