            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title">Daftar Penjualan per Sales (Mega Auto Prima - Cabang)</h5>
                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exportModal">
                            <i class="feather-download me-2"></i> Export Laporan per Sales
                        </button>
                    </div>
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('salesperson-sales.transactions.map-branch.export-all-per-sales') }}" method="GET">
                    <div class="modal-body">
                        <p>Pilih rentang tanggal untuk data yang akan diekspor.</p>
                        <div class="mb-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadData(cursor = null) {
                ...
                fetch(`{{ route('salesperson-sales.transactions.map.branch.data') }}?${params}`)
                    .then(res => res.json())
                    .then(res => {
