...
@section('title', 'Data Program Promosi Milenia')
            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><i class="feather-award me-2"></i>Daftar Semua Program Promosi Milenia
                        </h5>
                        {{-- Sesuaikan dengan route create Anda --}}
                        <a href="{{ route('promotion-program.milenia.create') }}" class="btn btn-primary btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center aksi-kolom">
                                                <div class="hstack gap-2 justify-content-center">
                                                    {{-- Tombol Lihat --}}
                                                    <a href="{{ route('promotion-program.milenia.show', $program->id) }}"
                                                        class="btn btn-sm btn-info">
                                                        <i class="feather-eye me-2"></i> Detail
                                                    </a>

                                                    {{-- Tombol Edit --}}
                                                    <a href="{{ route('promotion-program.milenia.edit', $program->id) }}"
