    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('promotion-program.map.index') }}">Data Program Promosi
                        MAP</a></li>
                <li class="breadcrumb-item">@yield('title')</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <a href="{{ route('promotion-program.map.index') }}" class="btn btn-secondary">
                                    ...
                                    @forelse ($promotionProgram->details as $detail)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ $detail->itemMap->MFIMA_ItemID ?? $detail->item_id }}</td>
                                            <td>{{ $detail->itemMap->MFIMA_Description ?? 'N/A' }}</td>
                                            <td class="text-center">{{ $detail->itemMap->mapBrands->MFIB_Description ?? 'N/A' }}</td>
                                        </tr>
                                    @empty
                                        <tr>
