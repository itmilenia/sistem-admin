...
{{-- 1. Ubah Judul --}}
@section('title', 'Tanda Tangan Sales Head: ' . $claim->retail_name)
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                {{-- 2. Ubah Breadcrumb --}}
                <li class="breadcrumb-item">TTD Sales Head</li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="card sticky-top" style="top: 20px;">
                    <div class="card-header">
                        {{-- 4. Ubah Judul Card --}}
                        <h5 class="card-title"><i class="feather-edit me-2"></i>Tanda Tangan Sales Head</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="sales-head-signature-form"
                            ...
                            <input type="hidden" name="sales_head_signature" id="sales_head_signature">

                            {{-- 7. Blok Tanda Tangan --}}
                            <div class="mb-3">
                                {{-- 8. Ubah Label --}}
                                <label for="signature-pad" class="form-label">Tanda Tangan Sales Head
                                ...
                                {{-- 9. Ubah Pesan Error --}}
                                <span class="signature-error" id="signature-error-msg">Tanda tangan Sales Head wajib
                                    diisi.</span>
                                {{-- 10. Ubah @error --}}
                                @error('sales_head_signature')
                            ...
                            <div class="d-flex justify-content-end">
                                {{-- 11. Ubah panggil JS --}}
                                <button type="button" class="btn btn-primary" onclick="confirmSalesHeadSignature()">
...
@push('scripts')
    ...
    <script>
        ...
        // (Ubah ini)
        const hiddenInput = document.getElementById('sales_head_signature');
        const form = document.getElementById('sales-head-signature-form');
        ...
        // 13. Sesuaikan Fungsi konfirmasi submit
        function confirmSalesHeadSignature() { // (Nama fungsi diubah)
            ...
            // (Tampilkan konfirmasi SweetAlert - Teks sama, sudah generik)
            Swal.fire({
                title: 'Konfirmasi Tanda Tangan?',
                text: "Apakah Anda yakin tanda tangan Anda sudah benar?",
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: 'Memproses...',
                        text: 'Sedang menyimpan tanda tangan. Mohon tunggu.',
