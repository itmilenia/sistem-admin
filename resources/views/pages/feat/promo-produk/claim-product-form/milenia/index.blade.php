...
@section('title', 'Data Klaim Produk Milenia')
            ...
            <div class="col-lg-12">
                <div class="card stretch stretch-full">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title"><i class="feather-file-text me-2"></i>Daftar Semua Klaim Produk Milenia
                        </h5>
                        @can('buat_klaim_produk_milenia')
                            <a href="{{ route('product-claim-form.milenia.create') }}" class="btn btn-primary btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="hstack gap-2 justify-content-center">
                                                    {{-- Tombol Lihat --}}
                                                    <a href="{{ route('product-claim-form.milenia.show', $claim->id) }}"
                                                        class="btn btn-sm btn-info">
                                                        <i class="feather-eye me-2"></i> Detail
                                                    </a>

                                                    {{-- Tombol Verifikasi untuk yang belum terverifikasi --}}
                                                    @can('verifikasi_klaim_produk_milenia')
                                                        @if (!$claim->verification_date)
                                                    ...
                                                    @can('tanda_tangan_sales_klaim_produk_milenia')
                                                    ...
                                                    @can('tanda_tangan_head_sales_klaim_produk_milenia')
                                                        @if (
                                                    ...
                                                    @can('hapus_klaim_produk_milenia')
                                                        {{-- Form Hapus --}}
                                                        @if (!$claim->checker_signature_path || !$claim->sales_signature_path || !$claim->sales_head_signature_path)
                                                            <form
