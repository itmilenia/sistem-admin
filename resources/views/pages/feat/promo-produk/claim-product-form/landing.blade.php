        ...
        <div class="card shadow-sm border-0">
            <div class="card-body py-5">
                <div class="text-center mb-5">
                    ...
                    <p class="lead text-muted">Silakan pilih jenis form klaim produk dari perusahaan yang ingin ditampilkan</p>
                </div>

                <div class="row justify-content-center">
                    @can('lihat_klaim_produk_milenia')
                        {{-- ========== MILENIA PUSAT ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                            <a href="{{ route('product-claim-form.milenia.index') }}" class="text-decoration-none">
                    ...
                    @can('lihat_klaim_produk_map')
                        {{-- ========== MAP PUSAT ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                            <a href="{{ route('product-claim-form.map.index') }}" class="text-decoration-none">
                                <div class="card shadow-lg border-0 h-100 hover-card"
