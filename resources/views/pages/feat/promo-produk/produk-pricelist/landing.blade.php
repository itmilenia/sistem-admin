        ...
        <div class="card shadow-sm border-0">
            <div class="card-body py-5">
                <div class="text-center mb-5">
                    <h1 class="fw-bold mb-3">Pilih Produk</h1>
                    <p class="lead text-muted">Silakan pilih jenis pricelist produk yang ingin ditampilkan</p>
                </div>

                <div class="row justify-content-center">
                    @can('lihat_data_pricelist_produk_milenia')
                        {{-- Milenia Mega Mandiri --}}
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('pricelist-produk-milenia.index') }}" class="text-decoration-none">
                    ...
                    @can('lihat_data_pricelist_produk_map')
                        {{-- Mega Auto Prima --}}
                        <div class="col-md-4 mb-4">
                            <a href="{{ route('pricelist-produk-map.index') }}" class="text-decoration-none">
                                <div class="card shadow-lg border-0 h-100 hover-card"
