        ...
        <div class="card shadow-sm border-0">
            <div class="card-body py-5">
                ...
                <div class="row justify-content-center">
                    @can('lihat_transaksi_customer_milenia_pusat')
                        {{-- ========== MILENIA PUSAT ========== --}}
                    ...
                    @can('lihat_transaksi_customer_milenia_cabang')
                        {{-- ========== MILENIA CABANG ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                    ...
                    @can('lihat_transaksi_customer_map_pusat')
                        {{-- ========== MAP PUSAT ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
                    ...
                    @can('lihat_transaksi_customer_map_cabang')
                        {{-- ========== MAP CABANG ========== --}}
                        <div class="col-md-6 col-lg-6 mb-4">
